...
bool worker_thread_publisher_task_publish_I(struct worker_thread_publisher_task_s* task, struct pubsub_topic_t topic, size_t size, pubsub_message_writer_func_ptr writer_cb, void* ctx) {
    chDbgCheckClassI();
