...
#define BOARD_PAL_LINE_CAN2_RX PAL_LINE(GPIOB,12)
#define BOARD_PAL_LINE_CAN2_TX PAL_LINE(GPIOB,6)
#define BOARD_PAL_LINE_CAN1_RX PAL_LINE(GPIOD,0)
#define BOARD_PAL_LINE_CAN1_TX PAL_LINE(GPIOD,1)
#define BOARD_PAL_LINE_USB_DM PAL_LINE(GPIOA,11)
#define BOARD_PAL_LINE_USB_DP PAL_LINE(GPIOA,12)
#define BOARD_PAL_LINE_TPIN1 PAL_LINE(GPIOD,5)
#define BOARD_PAL_LINE_TPIN2 PAL_LINE(GPIOD,6)
